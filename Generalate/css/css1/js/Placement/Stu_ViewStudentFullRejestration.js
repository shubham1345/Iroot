...
function LoadStudentDetails(no) {
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#viewstudent").append("<tr><td><b>ScholarNumber</b><td>" + data.d[0].ScholarNo + "</td><td><b>Student Name</b></td><td>" + data.d[0].StudentName + "</td></tr>"
                                   ...
                                   + "<tr><td><b>Scholar Number</b><td hidden='hidden'>" + data.d[0].ScholarNo + "</td><td><b>Category</b></td><td>" + data.d[0].Category + "</td></tr>"
        ...
        success: function (data) {
            for (var i = 0; i < data.d.length; i++) {
                $("#Academic").append("<tr><td hidden='hidden'>" + data.d[i].AcademicDetailId + "</td><td>" + data.d[i].AcademicYear + "</td><td>" + data.d[i].Qualification
                    + "</td><td>" + data.d[i].Institution + "</td><td>" + data.d[i].University + "</td><td>" + data.d[i].Percentage + "</td></tr>");
...
function GetWorkExperience(no) {
    ...
    $.ajax({
        ...
        success: function (data) {
            for (var i = 0; i < data.d.length; i++) {
                //$("#workexpern").append("<tr><td hidden='hidden'>" + data.d[i].WorkExperienceId + "</td><td>" + data.d[i].TotalExperience + "</td><td>" + data.d[i].CompanyName
                ...
                //+ '<a href="#" onclick="return getWorkExpDetailsById(' + data.d[i].WorkExperienceId + ')">Edit</a> | <a href="#" onclick="DeleleWorkExp(' + data.d[i].WorkExperienceId + ')">Delele</a></td><tr>');
            }

    ...
    $.getJSON("GetAll",
        function (json) {
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                tr.append("<td>" + json[i].DiamondJubilee + "</td>");
...
function jubileeDateCalculation() {
    ...
    var month = monthNdate[1];
    var day = monthNdate[0];

...
$(document).ready(function () {
    ...
    $('#printbtn').click(function () {
        window.open('../LivingOutsideTheCongregation/LivingOutsideReport');
    });
...
function Add() {
    ...
    var general =
        {
            LivingOutsideId: $('#LivingOutsideId').val(),
    ...
    $.ajax({
        url: "../LivingOutsideTheCongregation/Add",
...
function getbyID(GId1) {
    $.ajax({
        url: "../LivingOutsideTheCongregation/GetById/" + GId1,
        type: "GET",
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        success: function (result) {
            
            $('#LivingOutsideId').val(result.LivingOutsideId);
...
function Update() {
    ...
    $.ajax({
        url: "../LivingOutsideTheCongregation/Update",
...
function Delele(ID) {
    ...
    if (ans) {
        $.ajax({
            url: "../LivingOutsideTheCongregation/Delete/" + ID,
            type: "POST",
            contentType: "application/json;charset=UTF-8",
            dataType: "json",
            success: function (result) {
...
function clearTextBox() {
    ...
    $('#LivingOutsideId').css('border-color', 'lightgrey');

    ...
    $.getJSON("GetAll",
        function (json) {
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                tr.append("<td> <a href=/Images/SeperationFromTheCongregation/" + json[i].DispensationLetter + " view>View</a></td>");
                //tr.append('<td><a href="#" onclick="DisplayDoc(\'' + json[i].DispensationLetter + '\')"></a> | <a href="#" onclick="DisplayDocument(\'' + json[i].DispensationLetter + '\')">Details</a></td>')
    ...
    var general =
        {
            ...
            DispensationLetter: $('#DispensationLetter').val()
...
function getbyID(GId1) {
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#DispensationLetter').val(result.DispensationLetter);
...
$("#FileUpload").change(function () {
    ...
    $.ajax({
        url: "../SeperationFromTheCongregation/UploadFile",
        type: "POST",
        processData: false,
        contentType: false,
        data: data,
        success: function (response) {
            //code after success
            $("#DispensationLetter").val(response);
        },
        error: function (er) {
            alert(er);
        }
...
function clearTextBox() {
    ...
    $('#DispensationLetter').css('border-color', 'lightgrey');

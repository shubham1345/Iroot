  ...
  //debugger;
    ...
    if (rdButton == "DeathAnnivers") {
        $.ajax({
            ...
            dataType: "json",
            success: function (familydata) {
                $('#TblDeath tbody tr').remove();
                if (familydata != null) {
                    var i = 1;
                    familydata.forEach(function (user) {
                        var row = "<tr><td>" + i + "</td><td>" + user.Name + "</td><td>" + user.SirName + "</td>";
                        $('#TblDeath tbody').append(row);
                        i = i + 1;
                    })
                    $("#DeathDiv").css("display", "block");
                }
        ...
        $.ajax({
            ...
            success: function (familydata) {
                ...
                if (familydata != null) {
                    var i = 1;
                    familydata.forEach(function (user) {
                        var row = "<tr><td>" + i + "</td><td>" + user.Knowname + "</td><td>" + user.Baptismialname + "</td>";

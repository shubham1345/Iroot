namespace Generalate.Migrations
{
    ...
    public partial class Tbl_ProGeneralCouncil : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.Tbl_ProGeneralCouncil",
                c => new
                    {
                        ProvGenCouncil_Id = c.Int(nullable: false, identity: true),
                ...
                .PrimaryKey(t => t.ProvGenCouncil_Id);
            
        }
        
        public override void Down()
        {
            DropTable("dbo.Tbl_ProGeneralCouncil");
        }
    }
}

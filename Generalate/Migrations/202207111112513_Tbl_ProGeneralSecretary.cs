namespace Generalate.Migrations
{
    ...
    public partial class Tbl_ProGeneralSecretary : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.Tbl_ProGeneralSecretary",
                c => new
                    {
                        ProvGenSecretary_Id = c.Int(nullable: false, identity: true),
                ...
                .PrimaryKey(t => t.ProvGenSecretary_Id);
            
        }
        
        public override void Down()
        {
            DropTable("dbo.Tbl_ProGeneralSecretary");
        }
    }
}

namespace Generalate.Migrations
{
    ...
    public partial class Tbl_ProGeneralMember : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.Tbl_ProGeneralMember",
                c => new
                    {
                        ProGenMem_Id = c.Int(nullable: false, identity: true),
                ...
                .PrimaryKey(t => t.ProGenMem_Id);
            
        }
        
        public override void Down()
        {
            DropTable("dbo.Tbl_ProGeneralMember");
        }
    }
}
